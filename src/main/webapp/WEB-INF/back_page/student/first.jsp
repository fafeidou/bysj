...
<html>
<head>
<title>论文双选系统，学生界面</title>
<meta http-equiv="pragma" content="no-cache">
<meta http-equiv="cache-control" content="no-cache">

<LINK rel="stylesheet" type="text/css" href="/res/js/easyui/styles/default.css">
...
<SCRIPT type="text/javascript">
	...
	$(function() {//预加载方法
		...
		$('#tabs').tabs('add', {
			title : '欢迎使用',
			content : createFrame('/system/student/welcome.do')
		}).tabs({
	...
	function logout() {
		_confirm('您确定要退出本系统吗?',null,
				function(){
					location.href = '/system/logout.do';
				}
		)
	}
	...
	function modifyPassword() {
		createmodalwindow("修改密码", 500, 200,
				'/student/myselfInfo/toModifyPassword.do');
	}
...
<BODY style="overflow-y: hidden;" class="easyui-layout" scroll="no" >
	<DIV
		...
		<SPAN style="padding-right: 20px; float: right;" class="head">
			欢迎当前用户：${sessionScope.student_session.student.studentName}&nbsp;&nbsp;
			<A href=javascript:showhelp()>使用帮助</A>
			&nbsp;&nbsp;
			<A title='修改密码'  href="javascript:modifyPassword()"  icon='icon-null' id="modifypwd" >修改密码</A>
			&nbsp;&nbsp;
			<A id="loginOut" href=javascript:logout()>退出系统</A>

		</SPAN> <SPAN style="padding-left: 10px; font-size: 16px;"><IMG
			align="absmiddle" src="/res/images/xxu.png" width="20" height="20">
			论文双选系统</SPAN> <SPAN style="padding-left: 15px;" id="News"></SPAN>
	</DIV>
