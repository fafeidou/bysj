		...
		if (MessageUtil.MESSAGE_TEXT.equals(msgType)) {
			if ("查看".equals(content)) {
				...
				if (weixinstudentstate != null) {
					content = "<a href=\"http://www.bycj.com.tunnel.qydev.com/wx/student/toLogin.do?studentId="
							+ weixinstudentstate.getStudentId() + "\">查看</a>";
				} else {
					// 没有绑定去登陆界面

					content = "<a href=\"http://www.bycj.com.tunnel.qydev.com/wx/student/toLogin.do?fromUserName="
							+ fromUserName + "\">绑定</a>";
				}
